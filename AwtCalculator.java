    ...
    AwtCalculator(){
     ...
     public void prepareFrame(){
      ...
      public void addComponents(){
        ...
        onCheckbox.setBackground(new Color(255,255,255));
        onCheckbox.setForeground(Color.black);
        ...
        offCheckbox.setBackground(new Color(255,255,255));
        offCheckbox.setForeground(Color.black);
